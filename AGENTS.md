...
- Self-descriptions use "en af de førende agentiske ingeniører" / "one of the leading agentic engineers"; never "Danmarks førende" (or another crown) as a self-description (captain, 2026-08-21). Query-form FAQ questions may still quote crown searches like "Hvem er Danmarks bedste AI-konsulent?"; the answers present him as "en af de..." with the numbers.
