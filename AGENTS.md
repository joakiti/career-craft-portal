...
- The DR article about The Tattoo Archive (dr.dk/.../udslaet-allergier-og-bylder-...) does not name Mikkel (fact-checked 2026-08-21): never use it in subjectOf or any press list. "The Tattoo Archive was covered by DR" remains valid as a fact about the app on project cards, text only.
