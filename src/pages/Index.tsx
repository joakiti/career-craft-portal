        ...
        <div className="container mx-auto max-w-7xl">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
            ...
            <div className="space-y-4">
              <div className="text-accent text-xs md:text-sm font-medium">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                ...
                <Link 
                  to="/services" 
                  className="inline-flex items-center justify-center px-3 py-2 rounded-lg border border-accent/20 text-accent hover:bg-accent/10 transition-colors text-xs md:text-sm"
                >
              ...
              <div className="flex gap-4 pt-2">
                <div>
                  <div className="text-base md:text-lg font-bold text-accent">10+</div>
                  <div className="text-xs text-gray-400">Years Experience</div>
                </div>
                <div>
                  <div className="text-base md:text-lg font-bold text-accent">5</div>
            ...
            <div className="relative">
              ...
              />
              <div className="absolute -bottom-4 -right-4 bg-card/80 backdrop-blur-sm rounded-2xl p-2 border border-accent/10 hidden md:block">
                <p className="text-white text-xs font-medium">10+ Years Industry Experience</p>
              </div>
            </div>
          </div>
        </div>
