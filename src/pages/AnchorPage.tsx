...
const STRINGS = {
  da: {
    ...
    whatBody: [
      "Mikkel Kaj Andersen arbejder i dag med quant og high-performance computing hos Copenhagen Energy Trading. Sideløbende driver han konsulentvirksomheden Synergy Software (CVR " +
        CONTACT.cvr +
  ...
  en: {
    ...
    whatBody: [
      "Mikkel Kaj Andersen currently works on quant and high-performance computing at Copenhagen Energy Trading. Alongside, he runs the consultancy Synergy Software (CVR " +
        CONTACT.cvr +
