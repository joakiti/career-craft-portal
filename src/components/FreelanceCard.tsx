  ...
  return (
    <Card className="bg-card-lighter border-gray-700 p-8">
      <div className="flex items-start justify-between mb-6">
        <div>
          <h3 className="text-xl font-bold text-link mb-2">SYNERGY SOFTWARE</h3>
          <p className="text-lg text-accent mb-1">Software Engineer & Founder</p>
      ...
      <div className="space-y-6">
        <div>
          <h4 className="text-lg font-semibold text-accent mb-3">Mobile Applications</h4>
          <ul className="list-disc list-inside text-gray-300 space-y-2">
            <li>Developed The Tattoo Archive for iOS and Android, featured in Danish media</li>
            <li>Created Gas Money App - Automatic route price calculation using Google APIs and custom Python scraper</li>
        ...
        <div>
          <h4 className="text-lg font-semibold text-accent mb-3">Enterprise Solutions</h4>
          <ul className="list-disc list-inside text-gray-300 space-y-2">
