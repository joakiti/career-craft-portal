                    ...
                    <div className="space-y-8">
                        <Card
                            ...
                            <div className="flex justify-between items-start mb-4">
                                ...
                                <Badge className="bg-accent text-card">MSc</Badge>
                            </div>
                            <p className="text-gray-300 mb-2">Aug. 2019 - Aug 2021</p>
                            <div className="space-y-2">
                                <p className="text-gray-300">Mastering Advanced Algorithms & Optimization</p>
                                <p className="text-accent">Outstanding Achievement: Top 10% (11.00/12.00)</p>
                            </div>
                        </Card>
                        ...
                        <Card
                            ...
                            <div className="flex justify-between items-start mb-4">
                                <h3 className="text-2xl font-extrabold text-white">IT-University of Copenhagen</h3>
                                <Badge className="bg-primary-light text-primary">BSc</Badge>
                            </div>
                            <p className="text-gray-300 mb-2">Aug. 2016 - Aug 2019</p>
                            <div className="space-y-2">
